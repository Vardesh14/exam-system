questions = {
    "Chemistry": [
        ...
        },
        {
            ...
            "options": ["6.022 x 10^23", "3.14 x 10^23", "9.8 x 10^23", "1.6 x 10^19"],
            "answer": "6.022 x 10^23"
        },
        {
            "question": "Which acid is present in vinegar?",
            "options": ["Citric acid", "Lactic acid", "Acetic acid", "Tartaric acid"],
            "answer": "Acetic acid"
        },
        {
            "question": "The atomic number of sodium is?",
            "options": ["10", "11", "12", "13"],
            "answer": "11"
        },
        {
        ...
        {
            "question": "Which bond is present in NaCl?",
